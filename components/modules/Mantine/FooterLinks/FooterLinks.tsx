import { Text, Container, ActionIcon, Group, rem, Image, useMantineColorScheme } from '@mantine/core';
    ...
    <footer className={classes.footer}>
      <Container className={classes.inner}>
        <div className={classes.logo}>
          <Image src={colorScheme == 'light' ? Images.logo_highpolar : Images.logo_highpolar_white} h={56} alt="logo"/>
